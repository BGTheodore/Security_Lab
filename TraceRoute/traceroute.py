...
def Traceroute(dest_name):  
    ...
    while True:
        ...
        if curr_name is not None: #if the conversion was successfull add it to current address
            print ('{} \t {}({})'.format(ttl,curr_name ,current_hop))
          
        else:
            print ('{} \t {}'.format(ttl,current_hop))
